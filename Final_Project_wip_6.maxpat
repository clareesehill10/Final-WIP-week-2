...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1823.583129999999983, 338.000938000000019, 157.0, 596.0 ],
					"text" : "This week I have been trying to figure out the Maxuino. I was able to get my the pwm working in the sample patch but I had trouble moving the sample patch I was able to get the pwm working briefly in my patch but I am not sure why it’s not working I am sure I have a hotmess of a patch. I also added an audio trigger section on the patch. I am not sure if I want to keep that section but for now it seems to be working. I went through a couple of iterations of that section of the patch because the section where the audio is read at the peakamp wouldn’t read the incoming audio. I believe there is some funny businesses with selector but just re build that section from the tutorial that I got the original from.  It looks pretty dope when it is working but I will see when I have everything working. Ideally what I would like to do is to have the audio reading from the peakamp read into the Maxuino part of the patch so that I have a LED or in the dream dream dream list my neon react to the sound. I will also try with an entec I was able to borrow but using the micro controller will be the best option and most cost effective. \n"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1857.0, 247.0, 48.0, 22.0 ],
					"text" : "loop $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1975.583129999999983, 290.063972000000035, 35.0, 20.0 ],
					"text" : "Rate"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1975.583129999999983, 312.063972000000035, 36.0, 22.0 ],
					"triscale" : 0.9,
					"varname" : "sfrate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1839.211547999999993, 325.063972000000035, 36.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1282.864196999999876, 215.982125999999994, 289.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1978.400015532970428, 588.200006127357483, 29.5, 22.0 ],
					"text" : "init"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2245.20002156496048, 621.852150696845911, 81.0, 22.0 ],
					"text" : "s to-maxuino"
				}
...
,
					"patching_rect" : [ 2308.483773564960302, 474.461952696846083, 106.0, 25.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 2308.483773564960302, 501.737037696846073, 120.0, 25.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "float" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 225.430175999999989, 199.475311000000005, 75.0, 31.0 ],
...
,
					"patching_rect" : [ 2308.483773564960302, 557.271583696845937, 56.0, 25.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 2308.483773564960302, 584.46195269684597, 70.0, 25.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
									"patching_rect" : [ 498.0, 264.857268999999974, 80.0, 20.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 369.0, 264.857268999999974, 83.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 123.198822000000007, 330.812591999999995, 114.272720000000007, 20.0 ],
									"text" : "analogWrite 6 0.503937"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 241.784119000000004, 264.857268999999974, 108.0, 20.0 ],
									"text" : "pack analogWrite 1 0."
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 212.238585999999998, 116.841492000000002, 49.0, 20.0 ]
								}
...
,
					"patching_rect" : [ 2308.483773564960302, 529.658180696845989, 110.0, 25.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 2308.483773564960302, 447.374656696845989, 104.0, 25.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 2308.483773564960302, 421.200004696846008, 110.0, 25.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1964.0, 629.63876300000004, 65.0, 22.0 ],
					"text" : "pinMode 6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2052.200002014636993, 576.340900045268995, 81.0, 22.0 ],
					"text" : "prepend port"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1994.200002014636766, 548.800007045269012, 135.0, 22.0 ],
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 227.0, 199.214874000000009, 122.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 2057.282993174739659, 700.67628685317618, 91.0, 29.0 ],
					"text" : "maxuino c",
					"varname" : "maxuino"
				}
...
,
					"patching_rect" : [ 2045.00001925230049, 472.200006127357483, 61.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2084.200002014636993, 388.000001132488251, 45.0, 22.0 ],
					"text" : "update"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 2128.599999999999909, 301.399999999999977, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 616.377858491474171, 689.5, 157.0, 49.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 2317.983773564960302, 444.870704696845962, 2254.70002156496048, 444.870704696845962 ],
					"source" : [ "obj-114", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-146", 0 ],
					"midpoints" : [ 2317.983773564960302, 471.870704696845905, 2254.70002156496048, 471.870704696845905 ],
					"source" : [ "obj-116", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-146", 0 ],
					"midpoints" : [ 2317.983773564960302, 552.870704696846019, 2254.70002156496048, 552.870704696846019 ],
					"source" : [ "obj-117", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1848.711547999999993, 354.433678000000043, 1770.694762999999966, 354.433678000000043 ],
					"source" : [ "obj-120", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-146", 0 ],
					"midpoints" : [ 2317.983773564960302, 579.870704696846019, 2254.70002156496048, 579.870704696846019 ],
					"source" : [ "obj-147", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-146", 0 ],
					"midpoints" : [ 2317.983773564960302, 609.061073696846051, 2254.70002156496048, 609.061073696846051 ],
					"source" : [ "obj-148", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-146", 0 ],
					"midpoints" : [ 2317.983773564960302, 525.870704696846019, 2254.70002156496048, 525.870704696846019 ],
					"source" : [ "obj-47", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-146", 0 ],
					"midpoints" : [ 2317.983773564960302, 498.870704696845905, 2254.70002156496048, 498.870704696845905 ],
					"source" : [ "obj-57", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1985.083129999999983, 342.902161000000035, 1808.694762999999966, 342.902161000000035 ],
					"source" : [ "obj-82", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-147::obj-147" : [ "live.slider[4]", "live.slider", 0 ],
			"obj-141::obj-125::obj-16" : [ "live.text", "live.text", 0 ],
...
,
		"dependency_cache" : [ 			{
				"name" : "maxuino.maxpat",
				"bootpath" : "./maxuino-master",
				"patcherrelativepath" : "../../../Applications/maxuino-master",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "maxuino.js",
				"bootpath" : "./maxuino-master/support",
				"patcherrelativepath" : "../../../Applications/maxuino-master/support",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "Teensy++.png",
				"bootpath" : "./maxuino-master/hardware",
				"patcherrelativepath" : "../../../Applications/maxuino-master/hardware",
				"type" : "PNG",
				"implicit" : 1
			}
, 			{
